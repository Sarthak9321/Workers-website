...
<body>
    ...
    <h6>The Rate for Carpenter is 700 per day</h6></div>
            <div class="userslist">
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT name, number, area, Emailid FROM users1 WHERE role='Worker' AND skill = 'carpenter' AND Is_Hired = '0'";
    ...
    <a href="carpentermapspage.php"><button style="border-radius: 20%;">Check Map</button></a>
</body>
</html>
